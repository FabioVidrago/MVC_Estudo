...
using MVC_Estudo.Models.Enums;

namespace MVC_Estudo.Data
{
    public class SeedingService
    {
        private MVC_EstudoContext _context;

        public SeedingService(MVC_EstudoContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SalesStatus.Canceled, s1);
